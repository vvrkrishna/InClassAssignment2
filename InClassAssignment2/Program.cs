...
namespace Project01_Introduction
{
 ...
 namespace AreaofTriangleHerons
    {
        // Calculate the area of a triangle using Heron's formula
        class Program
        {
            static void Main(string[] args)
            {
                try
                {
                    ...
                    if (a + b > c || b + c > a || a + c > b)
                    {
                        ...
                        Debug.WriteLine("Area of the traingle is " + Area);
                    }
                    else
                    {
                        Debug.WriteLine("Not a valid Input ");
                    }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                if (a%2==0)
                {
                    Debug.WriteLine("Given Number is identifies as Even");
                }
                else
                {
                    Debug.WriteLine("Given Number is identified as odd");
                }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                if (a >b & a>c)
                {
                    Debug.WriteLine("Greatest number is" +a);
                }
                else (b > a & b > c)
                {
                    Debug.WriteLine("Greatest number is" + b);
                }
